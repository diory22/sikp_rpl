...
@endif
            <div class="card">
                <div class="card-header">
                    <div class="pull-left">
                        <strong>Pengajuan KP</strong>
                    </div>
                    <div class="pull-right">
                        <a href="{{ url('kp/tambahkp') }}" class="btn btn-success btn-sm">
                    ...
                    @foreach ($kp as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ url('kp/editkp/' .$item->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <form action="{{ url('kp/' .$item->id) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
                                    @method('delete')
                                    @csrf
