...
<body>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form action="{{ url('suratketerangan/'.$suratketerangan->id) }}" method="post">
                        @method('patch')
                        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="lembaga" id="lembaga" value="{{ $suratketerangan->lembaga }}" autofocus required>
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">Pimpinan</label>
            <input type="text" class="form-control" name="pimpinan" id="pimpinan" value="{{ $suratketerangan->pimpinan }}" autofocus required>
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">No. Telp</label>
            <input type="text" class="form-control" name="no_telp" id="no_telp" value="{{ $suratketerangan->no_telp }}" autofocus required>
        </div>
        <div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Alamat</label>
  <textarea name ="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3" autofocus required>{{ $suratketerangan->alamat }}</textarea>
</div>
        <div class="form-group">
