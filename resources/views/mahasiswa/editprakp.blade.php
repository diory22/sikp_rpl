...
<body>
        ...
        <div class="content mt-3">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="pull-left">
                        <strong>Edit Pengajuan Pra KP</strong>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form action="{{ url('prakp/'.$prakp->id) }}" method="post">
                        @method('patch')
                        @csrf
  ...
  <textarea name ="judul" class="form-control" id="exampleFormControlTextarea1" rows="3" autofocus required>{{ $prakp->judul }}</textarea>
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Tools</label>
  <textarea name ="tools" class="form-control" id="exampleFormControlTextarea1" rows="3" autofocus required>{{ $prakp->tools }}</textarea>
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Spesifikasi</label>
  <textarea name ="spesifikasi" class="form-control" id="exampleFormControlTextarea1" rows="3" autofocus required>{{ $prakp->spesifikasi }}</textarea>
</div>
        <div class="form-group">
            <label for="exampleFormControlInput1">Lembaga</label>
            <input type="text" class="form-control" name="lembaga" id="lembaga" value="{{ $prakp->lembaga }}" autofocus required>
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">Pimpinan</label>
            <input type="text" class="form-control" name="pimpinan" id="pimpinan" value="{{ $prakp->pimpinan }}" autofocus required>
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">No. Telp</label>
            <input type="text" class="form-control" name="no_telp" id="no_telp" value="{{ $prakp->no_telp }}" autofocus required>
        </div>
        <div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Alamat</label>
  <textarea name ="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3" autofocus required>{{ $prakp->alamat }}</textarea>
</div>
        <div class="form-group">
