...
@endif
            <div class="card">
                <div class="card-header">
                    <div class="pull-left">
                        <strong>Pengajuan Pra KP</strong>
                    </div>
                    <div class="pull-right">
                        <a href="{{ url('prakp/tambahprakp') }}" class="btn btn-success btn-sm">
                    ...
                    @foreach ($prakp as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ url('prakp/' .$item->id) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
                                    @method('delete')
                                    @csrf
