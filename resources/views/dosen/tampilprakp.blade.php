                ...
                <tbody>
                    @foreach ($prakp as $item)
                        <tr>
                            ...
                            <td>
                            @if($item->status == 0)
                                <a href="{{ url('dosen/prosessetujuiprakp/' .$item->id) }}" class="btn btn-success btn-sm">Setuju
                                </a>
                            @else
                            <a href="{{ url('dosen/prosesbatalprakp/' .$item->id) }}" class="btn btn-danger btn-sm">Tidak setuju
                                </a>
                            @endif
